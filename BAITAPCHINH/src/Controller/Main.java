...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try  {
            in= new FileReader("/Users/kimngan/Documents/java/BAITAPCHINH/src/FILEtxt/input.txt");
            out= new FileWriter("/Users/kimngan/Documents/java/BAITAPCHINH/src/FILEtxt/output.txt");
            for (Student student : students) {
